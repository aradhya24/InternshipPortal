...
.btn-news.btn-contests a:hover {
  ...
  <body>
    ...
    <form class="signup-form" action="save" method="post">
      ...
      <div class="form-body">
        ...
        <div class="horizontal-group">
          <div class="form-group left">
            ...
            <input type="text" id="firstname" name="name" class="form-input" placeholder="enter your full name" required="required" />
          </div>
          <div class="form-group right">
            <label for="lastname" class="label-title">Class and Semester</label>
            <input type="text" id="lastname" name="year" class="form-input" placeholder="Enter your Class and Semester" />
          </div>
      <div class="form-group leftt">
          <label for="lastname" class="label-title">Branch</label>
          <input type="text" id="lastname" name="branch" class="form-input" placeholder="Enter Your Branch" />
        </div>
      </div>
      <div class="form-group right">
        <label for="prnno" class="label-title">PRN No. </label>
        <input type="text" id="prn" name="prn" class="form-input" placeholder="Enter your PRN No." />
      </div>
       <div class="form-group">
       <label for="mobno" class="label-title">Mobile No.</label>
       <input type="text" id="email" name="mobNo" class="form-input" placeholder="enter your no" required="required">
     </div>
   ...
   <!-- Mobile no -->
       ...
       <input type="text" id="lastname" name="address" class="form-input" placeholder="enter your residential address" required="required">
     </div>
...
<!-- percentage -->
        <div class="form-group input-type input-type--percentage">
          ...
          <input placeholder="Enter your CGPA "class="input input--number input-type__input" data-qa="input-number" pattern="[0-9]*" id="answer" name="cgpa" value="" required>
...
<!-- company name -->
      <div class="form-group">
        ...
        <input type="text" id="email" class="form-input" name=organizationName placeholder="Enter Organization or Company Name " required="required">
      </div>
 
    <!-- start date of interneship -->
      <div class="form-group">
        <label for="startdate" class="label-title">Start date of Internship: </label>
        <input type="date" id="email" name="internshipStartDate" class="form-input"  placeholder="Enter Start date of Internship " required="required">
      </div>

       <!-- End date of interneship -->
       <div class="form-group">
        <label for="enddate" class="label-title">End date of Internship: </label>
        <input type="date" id="email" name=internshipEndDate class="form-input" placeholder="Enter end date of Internship ">
      </div>
